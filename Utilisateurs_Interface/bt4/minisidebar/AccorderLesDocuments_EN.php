                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            <h4 class="card-title"> Valider les documents :</h4><br><br>
                            ...
                            if($cycle=='Licence'){
                                    ...
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        <thead>
                                            <tr>
                                                ...
                                                <th style='display: table-cell;width: 171.9375px;'>Rapport</th>
                                                <th style=';display: table-cell;width: 221.9375px;'>Présentation</th>
                                                <th style='padding-left: 3%;display: table-cell;width: 132px;''>Statut</th>
                                            </tr>
                                        </thead>
                                        <tbody>";
                                        $sql=$bdd->prepare('SELECT trombinoscope.Num_groupe,trombinoscope.Etudiant_e_1,trombinoscope.Etudiant_e_2,trombinoscope.Etudiant_e_3,trombinoscope.Option_S6,trombinoscope.Encadrant,pfe.Rapport,pfe.Presentation,pfe.Statut_PFE,pfe.Sujet_PFE FROM pfe JOIN affecter_sujet JOIN trombinoscope ON pfe.N__SOM=affecter_sujet.N__SOM AND pfe.Sujet_PFE=affecter_sujet.Sujet AND affecter_sujet.Num_groupe=trombinoscope.Num_groupe WHERE trombinoscope.Nom_filiere=? AND trombinoscope.Option_S6=? AND affecter_sujet.N__SOM=?');
                                        $sql->execute(array($filiere,$option1,$_SESSION['N__SOM']));
                                        $Num1=1;
                                        while ($row=$sql->fetch()){ 
                                            $Num_groupe=$row[0];
                                            ...
                                            echo "<td ><h4 style='padding-top: 85%;'>".$Num1."</h4></td>";
                                                ...
                                                if ($row[6]!=NULL) {
                                                echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='rapport".$Num1."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[6]."\"'><i class='fa fa-file-pdf-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if ($row[7]!=NULL) {
                                                    echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='presentation".$Num1."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[7]."\"'><i class='fa fa-file-powerpoint-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if($row[8]==1){
                                                    ...
                                                    echo "<td style='padding-top:2.5%;'>
                                                            <button type='submit' class='btn btn-secondary btn-circle' name='true1".$Num1."'><i class='fa fa-check'></i>
                                                            </button>
                                                            <button type='submit' class='btn btn-warning btn-circle' name='false1".$Num1."'><i class='fa fa-times'></i> </button>
                                                        </td>";
                                                }
                                                }
                                                else{
                                            ...
                                            echo "</tr>";
                                            if (isset($_POST['true1'.$Num1])) {
                                                $true1=$bdd->prepare("UPDATE pfe SET Statut_PFE=1 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $true1->execute(array($row[9],$_SESSION['N__SOM']));
                                            }else{
                                                $false1=$bdd->prepare("UPDATE pfe SET Statut_PFE=0 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $false1->execute(array($row[9],$_SESSION['N__SOM']));
                                            }
                                            $Num1++;
                                        }
                                        echo "</tbody>
                                ...
                                echo "<div class='table-responsive'>
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        <tbody>";
                                        $sql=$bdd->prepare('SELECT trombinoscope.Num_groupe,trombinoscope.Etudiant_e_1,trombinoscope.Etudiant_e_2,trombinoscope.Etudiant_e_3,trombinoscope.Option_S6,trombinoscope.Encadrant,pfe.Rapport,pfe.Presentation,pfe.Statut_PFE,pfe.Sujet_PFE FROM pfe JOIN affecter_sujet JOIN trombinoscope ON pfe.N__SOM=affecter_sujet.N__SOM AND pfe.Sujet_PFE=affecter_sujet.Sujet AND affecter_sujet.Num_groupe=trombinoscope.Num_groupe WHERE trombinoscope.Nom_filiere=? AND trombinoscope.Option_S6=? AND affecter_sujet.N__SOM=?');
                                        $sql->execute(array($filiere,$option2,$_SESSION['N__SOM']));
                                        $Num2=1;
                                        while ($row=$sql->fetch()){ 
                                            $Num_groupe=$row[0];
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num2."</h4></td>";
                                                ...
                                                if ($row[6]!=NULL) {
                                                echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='rapport".$Num2."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[6]."\"'><i class='fa fa-file-pdf-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if ($row[7]!=NULL) {
                                                    echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='presentation".$Num2."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[7]."\"'><i class='fa fa-file-powerpoint-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if ($row[8]!=NULL) {
                                                if($row[8]==1){
                                                    echo "<td><h4 style='color:green; text-align:center;padding-top:40%;'><i class='ti-check'></i></h4></td>";
                                                }else{
                                                    echo "<td style='padding-top:2.5%;'>
                                                            <button type='submit' class='btn btn-secondary btn-circle' name='true2".$Num2."'><i class='fa fa-check'></i>
                                                            </button>
                                                            <button type='submit' class='btn btn-warning btn-circle' name='false2".$Num2."'><i class='fa fa-times'></i> </button>
                                                        </td>";
                                                }
                                                }
                                                else{
                                            ...
                                            echo "</tr>";
                                            if (isset($_POST['true2'.$Num2])) {
                                                $true2=$bdd->prepare("UPDATE pfe SET Statut_PFE=1 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $true2->execute(array($row[9],$_SESSION['N__SOM']));
                                            }else{
                                                $false2=$bdd->prepare("UPDATE pfe SET Statut_PFE=0 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $false2->execute(array($row[9],$_SESSION['N__SOM']));
                                            }
                                            $Num2++;
                                        }
                                        echo "</tbody>
                                ...
                                echo "<div class='table-responsive'>
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        <tbody>";
                                        $sql=$bdd->prepare('SELECT trombinoscope.Num_groupe,trombinoscope.Etudiant_e_1,trombinoscope.Etudiant_e_2,trombinoscope.Etudiant_e_3,trombinoscope.Option_S6,trombinoscope.Encadrant,pfe.Rapport,pfe.Presentation,pfe.Statut_PFE,pfe.Sujet_PFE FROM pfe JOIN affecter_sujet JOIN trombinoscope ON pfe.N__SOM=affecter_sujet.N__SOM AND pfe.Sujet_PFE=affecter_sujet.Sujet AND affecter_sujet.Num_groupe=trombinoscope.Num_groupe WHERE trombinoscope.Nom_filiere=? AND trombinoscope.Option_S6=? AND affecter_sujet.N__SOM=?');
                                        $sql->execute(array($filiere,$option3,$_SESSION['N__SOM']));
                                        $Num3=1;
                                        while ($row=$sql->fetch()){ 
                                            $Num_groupe=$row[0];
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num3."</h4></td>";
                                                ...
                                                <td></td>";
                                                 ...
                                                 if ($row[6]!=NULL) {
                                                echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='rapport".$Num3."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[6]."\"'><i class='fa fa-file-pdf-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if ($row[7]!=NULL) {
                                                    echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='presentation".$Num3."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[7]."\"'><i class='fa fa-file-powerpoint-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if($row[8]==1){
                                                    ...
                                                    echo "<td style='padding-top:2.5%;'>
                                                            <button type='submit' class='btn btn-secondary btn-circle' name='true3".$Num3."'><i class='fa fa-check'></i>
                                                            </button>
                                                            <button type='submit' class='btn btn-warning btn-circle' name='false3".$Num3."'><i class='fa fa-times'></i> </button>
                                                        </td>";
                                                }
                                                }
                                                else{
                                            ...
                                            echo "</tr>";
                                            if (isset($_POST['true3'.$Num3])) {
                                                $true3=$bdd->prepare("UPDATE pfe SET Statut_PFE=1 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $true3->execute(array($row[9],$_SESSION['N__SOM']));
                                            }else{
                                                $false3=$bdd->prepare("UPDATE pfe SET Statut_PFE=0 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $false3->execute(array($row[9],$_SESSION['N__SOM']));
                                            }
                                            $Num3++;
                                        }
                                        echo "</tbody>
                                    ...
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        <tbody>";
                                        $sql=$bdd->prepare('SELECT trombinoscope.Num_groupe,trombinoscope.Etudiant_e_1,trombinoscope.Etudiant_e_2,trombinoscope.Etudiant_e_3,trombinoscope.Encadrant,pfe.Rapport,pfe.Presentation,pfe.Statut_PFE,pfe.Sujet_PFE FROM pfe JOIN affecter_sujet JOIN trombinoscope ON pfe.N__SOM=affecter_sujet.N__SOM AND pfe.Sujet_PFE=affecter_sujet.Sujet AND affecter_sujet.Num_groupe=trombinoscope.Num_groupe WHERE trombinoscope.Nom_filiere=? AND affecter_sujet.N__SOM=?');
                                        $sql->execute(array($filiere,$_SESSION['N__SOM']));
                                        $Num=1;
                                        while ($row=$sql->fetch()){ 
                                            $Num_groupe=$row[0];
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num."</h4></td>";
                                                ...
                                                if ($row[2]!=NULL && $row[3]!=NULL) {
                                                    if ($row[2]!='  ' && $row[3]!='  '){
                                                       echo "<td style='padding-top: 2%;display: table-cell;'><a href='' ><img src=$etud2_1[2] alt='etudiant(e)2' class='img-circle' style='width:60px;'/> ".$etud2_1[0]." ".$etud2_1[1]."</a></td>";
                                                       echo "<td style='padding-top: 2.6%;display: table-cell;'><a href='' ><img src=$etud3_1[2] alt='etudiant(e)3' class='img-circle' style='width:30px;'/> ".$etud3_1[0]." ".$etud3_1[1]."</a></td>";
                                                ...
                                                if ($row[5]!=NULL) {
                                                echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='rapport".$Num."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[5]."\"'><i class='fa fa-file-pdf-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if ($row[6]!=NULL) {
                                                    echo "<td style=' padding-top:3%;padding-left:2.5%;'>
                                                    <button type='button' style='background: #6f42c1;color: white; border-radius:18%;font-size: 20px;' name='presentation".$Num."' onclick='window.location.href=\"http://localhost/monPFE/Utilisateurs_Interface/bt4/minisidebar".$row[6]."\"'><i class='fa fa-file-powerpoint-o' style='padding-top: 23%;'></i>
                                                    </button>
                                                    </td>";
                                                ...
                                                if($row[7]==1){
                                                    ...
                                                    echo "<td style='padding-top:2.5%;'>
                                                            <button type='submit' class='btn btn-secondary btn-circle' name='true1".$Num."'><i class='fa fa-check'></i>
                                                            </button>
                                                            <button type='submit' class='btn btn-warning btn-circle' name='false1".$Num."'><i class='fa fa-times'></i> </button>
                                                        </td>";
                                                }
                                                }
                                                else{
                                            ...
                                            echo "</tr>";
                                            if (isset($_POST['true1'.$Num])) {
                                                $true1=$bdd->prepare("UPDATE pfe SET Statut_PFE=1 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $true1->execute(array($row[8],$_SESSION['N__SOM']));
                                            }else{
                                                $false1=$bdd->prepare("UPDATE pfe SET Statut_PFE=0 WHERE Sujet_PFE=? AND N__SOM=?");
                                                $false1->execute(array($row[8],$_SESSION['N__SOM']));
                                            }
                                            $Num++;
                                }
                                echo "</tbody>

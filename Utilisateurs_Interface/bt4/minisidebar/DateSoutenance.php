<?php
    ...
    $etudiant_req=$bdd->prepare("SELECT Code_PFE FROM etudiant WHERE Nom_filiere=?");
    $etudiant_req->execute(array($_SESSION['Nom_filiere']));
    ...
    while ($pfe=$etudiant_req->fetch()) { 
    $sql=$bdd->prepare('INSERT INTO soutenance(Date_soutenance,Annee_univ,Code_PFE) VALUES (?,?,?)');
    $sql->execute(array($date,$annee_universitaire,$pfe[0]));
    }
    $etudiant_req->closeCursor();
    }

    
    if ($sql==true) {
            $message='<br><br><h4 style="color:green; text-align:center;"><i class="ti-check">'.' la date a été envoyé avec succès</i></h4>';
        }
?>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style="text-align:center;">
                                <h3 class="card-title">Date soutenance :</h3>
                            </div>
                            <div class="card-body">
                                <form method="post" action="" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="form-group row" style="padding-left: 40%;padding-right: 40%">
                                            <div class="col-md-12 input-group">
                                                <input type="date" class="form-control mydatepicker" placeholder="dd/mm/yyyy" name="date">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="offset-sm-3 col-md-9" style="padding-left: 21.1%">
                                                        <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-paper-plane"></i> Envoyer</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

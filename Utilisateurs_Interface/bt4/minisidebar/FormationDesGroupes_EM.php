                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-paging="true" data-paging-size="7">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="display: table-cell;width: 221.9375px;padding-bottom: 2%;text-align:center;">Sujet</th>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            $req_doc=$bdd->prepare("SELECT pfe.Statut_PFE FROM pfe JOIN affecter_sujet ON pfe.Sujet_PFE=affecter_sujet.Sujet WHERE affecter_sujet.Num_groupe=?");
                                            ...
                                            echo "<tr>";
                                            echo "<td ><h4 style='padding-top: 28%;'>".$Num."</h4></td>";
                                                if ($row[1]!=NULL) {
                                                    if ($row[1]!='  ') {
                                                ...
                                                echo "<td style='padding-top:3%;text-align:center;'><h5>".$row[5]."</h5>";
                            ...
                            <?php
                                        header('location:FormationDesGroupes_EM.php');
                            ?>
                            </div>
                        </div>
                    </div>

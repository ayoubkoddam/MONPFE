                        ...
                        <div class="card"> 
                            ...
                            <div class="card-img-overlay card-inverse text-white social-profile d-flex justify-content-center">
                                <div class="align-self-center">
                                    ...
                                    <br><br>
                                    <h4 class="card-title"><?= $_SESSION['Nom_enseignant'] .' '.$_SESSION['Prenom_enseignant'] ?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="card"> 
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-material" method="post" action="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="email" placeholder="Enseignant@monpfe.com" class="form-control form-control-line" name="email" value="<?=$_SESSION['E_mail_enseignant']?>">
                                                </div>
                                            </div>
                                            <div class="form-group">

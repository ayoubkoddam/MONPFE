                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            if ($count>0) {
                                ...
                                while ($filier=$fil->fetch()) {
                                    ...
                                    $filiere=$filier[0];
                                    $req=$bdd-> prepare("SELECT Cycle FROM filiere WHERE Nom_filiere=?");
                                    ...
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 85%;'>".$Num1."</h4></td>";
                                                ...
                                                if ($row[6]!=NULL) {
                                                if($row[6]==1){
                                                    echo "<td style='padding-top:2.5%;''><h4 style='color:green; text-align:center;padding-top:30%;'><i class='ti-check'></i></h4></td>";
                                                }else{
                                                    echo "<td style='padding-top:2.5%;'><h4 style='color:red; text-align:center;padding-top:30%;'><i class='ti-close'></i></h4></td>";
                                                }
                                                }else{
                                                    echo "<td style='padding-top:2.5%;'><h4 style='color:green; text-align:center;padding-top:30%;'></h4></td>";
                                                }
                                            echo "</tr>";
                                            ...
                                            if (isset($_POST['trombinoscope'])){
                                                ...
                                                header('location:AffectationDesSujets_EN.php');
                                            }
                                        }
                                        $sql->closeCursor();
                                        echo "</tbody>

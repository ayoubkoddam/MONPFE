                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            <h4 class="card-title"> Affectation des encadrants :</h4><br><br>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 85%;'>".$Num1."</h4></td>";
                                                ...
                                                echo "<td style=' padding-top:3%;'><h5>".$row[5]."</h5></td>";
                                                    ...
                                                    echo "<td style=' padding-top:2%;'><input type='text' class='dataTables_filter' name='encadrant1".$Num1."' style='width: 106px;'></td>";
                                                }
                                                if ($sujet1[0]!=NULL) {
                                                ...
                                                if ($row[6]!=NULL) {
                                                if($row[6]==1){
                                                    echo "<td style='padding-top:2%;'><h4 style='color:green; text-align:center;padding-top:30%;'><i class='ti-check'></i></h4></td>";
                                                }else{
                                                    echo "<td style='padding-top:2%;'><h4 style='color:red; text-align:center;padding-top:30%;'><i class='ti-close'></i></h4></td>";
                                                }
                                                }else{
                                                    echo "<td style='padding-top:2%;'><h4 style='color:green; text-align:center;padding-top:30%;'></h4></td>";
                                                }
                                            echo "</tr>";
                                            $encadrant1=$_POST['encadrant1'.$Num1];
                                            $Num1++;
                                            if (isset($_POST['trombinoscope'])) {
                                                $Enc1=$bdd->prepare("SELECT N__SOM FROM enseignant WHERE Nom_enseignant=?");
                                                $Enc1->execute(array($encadrant1));
                                                $SOM1=$Enc1->fetch();
                                                $etud1_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud1_req->execute(array($SOM1[0],$row[1]));
                                                $etud2_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud2_req->execute(array($SOM1[0],$row[2]));
                                                $etud3_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud3_req->execute(array($SOM1[0],$row[3]));
                                                $req=$bdd->prepare("UPDATE trombinoscope SET Encadrant=? WHERE Num_groupe=?");
                                                $req->execute(array($encadrant1,$row[0]));
                                                header('location:AffectationDesEncadrants.php');
                                            }
                                        }
                                        echo "</tbody>
                                            <tfoot>        
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num2."</h4></td>";
                                                ...
                                                echo "<td style=' padding-top:3%;'><h5>".$row[5]."</h5></td>";
                                                    ...
                                                    echo "<td style=' padding-top:2%;'><input type='text' class='dataTables_filter' name='encadrant2".$Num2."' style='width: 106px;'></td>";
                                                }
                                                if ($sujet2[0]!=NULL) {
                                            ...
                                            echo "</tr>";
                                            $encadrant2=$_POST['encadrant2'.$Num2];
                                            $Num2++;
                                            if (isset($_POST['trombinoscope'])) {
                                                $Enc2=$bdd->prepare("SELECT N__SOM FROM enseignant WHERE Nom_enseignant=?");
                                                $Enc2->execute(array($encadrant2));
                                                $SOM2=$Enc2->fetch();
                                                $etud1_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud1_req->execute(array($SOM2[0],$row[1]));
                                                $etud2_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud2_req->execute(array($SOM2[0],$row[2]));
                                                $etud3_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud3_req->execute(array($SOM2[0],$row[3]));
                                                $req=$bdd->prepare("UPDATE trombinoscope SET Encadrant=? WHERE Num_groupe=?");
                                                $req->execute(array($encadrant2,$row[0]));
                                                header('location:AffectationDesEncadrants.php');
                                            }
                                        }
                                        echo "</tbody>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num3."</h4></td>";
                                                ...
                                                echo "<td style=' padding-top:3%;'><h5>".$row[5]."</h5></td>";
                                                    ...
                                                    echo "<td style=' padding-top:2%;'><input type='text' class='dataTables_filter' name='encadrant3".$Num3."' style='width: 106px;'></td>";
                                                }
                                                if ($sujet3[0]!=NULL) {
                                            ...
                                            echo "</tr>";
                                            $encadrant3=$_POST['encadrant3'.$Num3];
                                            $Num3++;
                                            if (isset($_POST['trombinoscope'])) {
                                                $Enc3=$bdd->prepare("SELECT N__SOM FROM enseignant WHERE Nom_enseignant=?");
                                                $Enc3->execute(array($encadrant1));
                                                $SOM3=$Enc3->fetch();
                                                $etud1_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud1_req->execute(array($SOM3[0],$row[1]));
                                                $etud2_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud2_req->execute(array($SOM3[0],$row[2]));
                                                $etud3_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud3_req->execute(array($SOM3[0],$row[3]));
                                                $req=$bdd->prepare("UPDATE trombinoscope SET Encadrant=? WHERE Num_groupe=?");
                                                $req->execute(array($encadrant3,$row[0]));
                                                header('location:AffectationDesEncadrants.php');
                                            }
                                        }
                                        echo "</tbody>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num."</h4></td>";
                                                ...
                                                echo "<td style=' padding-top:3%;'><h5>".$row[5]."</h5></td>";
                                                    ...
                                                    echo "<td style=' padding-top:2%;'><input type='text' class='dataTables_filter' name='encadrant".$Num."' style='width: 106px;'></td>";
                                                }
                                                if ($sujet1[0]!=NULL) {
                                                echo "<td><h5 style='padding-top: 6%;'>".$sujet1[0]."</h5></td>";
                                                }else{
                                            ...
                                            echo "</tr>";
                                            $encadrant=$_POST['encadrant'.$Num];
                                            $Num++;
                                            if (isset($_POST['trombinoscope'])) {
                                                $Enc=$bdd->prepare("SELECT N__SOM FROM enseignant WHERE Nom_enseignant=?");
                                                $Enc->execute(array($encadrant));
                                                $SOM=$Enc->fetch();
                                                $etud1_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud1_req->execute(array($SOM[0],$row[1]));
                                                $etud2_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud2_req->execute(array($SOM[0],$row[2]));
                                                $etud3_req=$bdd->prepare("UPDATE etudiant SET N__SOM=? WHERE CNE=?");
                                                $etud3_req->execute(array($SOM[0],$row[3]));
                                                $req=$bdd->prepare("UPDATE trombinoscope SET Encadrant=? WHERE Num_groupe=?");
                                                $req->execute(array($encadrant,$row[0]));
                                                header('location:AffectationDesEncadrants.php');
                                            }

...
include '../../../connection.php';
    ...
    $cne=$_SESSION['CNE'];
    $query=$bdd->prepare('SELECT Code_soutenance FROM soutenance WHERE Code_PFE=?');
    $query->execute(array($_SESSION['Code_PFE']));
    $row=$query->fetch();
if (isset($row[0])){
    $soutenance=$bdd->prepare('UPDATE Etudiant SET Code_soutenance=?WHERE CNE=?');
    $soutenance->execute(array($row[0],$cne));
}
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Filière</strong>
                                                <br>
                                                <p class="text-muted"><?=$_SESSION['Nom_filiere']."/".$_SESSION['Option_S6']?></p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-material" method="post" action="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="email" placeholder="Etudiant@monpfe.com" class="form-control form-control-line" name="email" value="<?=$_SESSION['E_mail_etudiant']?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="password" value="Mot de passe" class="form-control form-control-line" name="password" value="<?=$_SESSION['Password_etudiant']?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">

                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            <h4 class="card-title">Télécharger la convention de stage</h4><br><br>
                            <div class="input-group">
                              <div class="input-group-append" style="padding-left: 45%; ">
                                <button class="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04" style="text-align: center; width: 150px;"><a href="../../../HTML2PDF/OutDocument/Convention.php" style="color: white;"><i class="ti-download"> Télécharger</i></a></button>
                              </div>
                            </div><br><br><br>
                        </div>
                    </div>

                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            <h4 class="card-title"> Valider les sujets :</h4><br><br>
                                    ...
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 85%;'>".$Num1."</h4></td>";
                                                ...
                                                if ($row[2]!=NULL && $row[3]!=NULL) {
                                                    if ($row[2]!='  ' && $row[3]!='  '){
                                                       ...
                                                       echo "<td style='padding-top: 2%;display: table-cell;'><a href='' ><img src=$etud3[2] alt='etudiant(e)3' class='img-circle' style='width:60px;'/> ".$etud3[0]." ".$etud3[1]."</a></td>";
                                                ...
                                                echo "<td><h5 style='padding-top: 4%;'></h5></td>";
                                                }
                                                if ($row[6]!=NULL) {
                                                if($row[6]==1){
                                            ...
                                            if (isset($_POST['true1'.$Num1])) {
                                                $true1=$bdd->prepare("UPDATE trombinoscope SET Statut_sujet=1 WHERE Num_groupe=?");
                                                $true1->execute(array($row[0]));
                                            }elseif (isset($_POST['false1'.$Num1])) {
                                                $false1=$bdd->prepare("UPDATE trombinoscope SET Statut_sujet=0 WHERE Num_groupe=?");
                                                $false1->execute(array($row[0]));
                                                $drop1=$bdd->prepare("DELETE FROM affecter_sujet WHERE Sujet=?");
                                                $drop1->execute(array($sujet1[0]));
                                            }
                                            $Num1++;
                                        }
                                        echo "</tbody>
                                    ...
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            if (isset($_POST['true2'.$Num2])) {
                                                $true2=$bdd->prepare("UPDATE trombinoscope SET Statut_sujet=1 WHERE Num_groupe=?");
                                                $true2->execute(array($row[0]));
                                            }elseif (isset($_POST['false2'.$Num2])) {
                                                $false2=$bdd->prepare("UPDATE trombinoscope SET Statut_sujet=0 WHERE Num_groupe=?");
                                                $false2->execute(array($row[0]));
                                                $drop2=$bdd->prepare("DELETE FROM affecter_sujet WHERE Sujet=?");
                                                $drop2->execute(array($sujet2[0]));
                                            }
                                            $Num2++;
                                        }
                                        echo "</tbody>
                                    ...
                                    <table id='demo-foo-addrow' class='table m-t-30 table-hover no-wrap contact-list' data-paging='true' data-paging-size='7'>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num3."</h4></td>";
                                                ...
                                                if ($sujet3[0]!=NULL) {
                                                echo "<td><h5 style='padding-top: 6%;'>".$sujet3[0]."</h5></td>";
                                                }else{
                                                echo "<td><h5 style='padding-top: 4%;'></h5></td>";
                                                }
                                                if ($row[6]!=NULL) {
                                            ...
                                            if (isset($_POST['true3'.$Num3])) {
                                                $true3=$bdd->prepare("UPDATE trombinoscope SET Statut_sujet=1 WHERE Num_groupe=?");
                                                $true3->execute(array($row[0]));
                                            }elseif (isset($_POST['false3'.$Num3])) {
                                                $false3=$bdd->prepare("UPDATE trombinoscope SET Statut_sujet=0 WHERE Num_groupe=?");
                                                $false3->execute(array($row[0]));
                                                $drop3=$bdd->prepare("DELETE FROM affecter_sujet WHERE Sujet=?");
                                                $drop3->execute(array($sujet3[0]));
                                            }
                                            $Num3++;
                                        }
                                        echo "</tbody>
                                        ...
                                        while ($row=$sql->fetch()){ 
                                            ...
                                            echo "<td ><h4 style='padding-top: 50%;'>".$Num."</h4></td>";
                                                ...
                                                if($row[6]==1){
                                                    ...
                                                    echo "<td style='padding-top:2%;'>
                                                            <button type='submit' class='btn btn-secondary btn-circle' name='true".$Num."'><i class='fa fa-check'></i>
                                                            </button>
                                                            <button type='submit' class='btn btn-warning btn-circle' name='false".$Num."'><i class='fa fa-times'></i> </button>
                                                        </td>";
                                                }
                                                }
                                                else{

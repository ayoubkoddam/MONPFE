            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-10">
                    <div class="menu_area">
                          ...
                          <a class="navbar-brand" href="#">MONPFE</a>
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    ...
                                    <li class="nav-item"><a  class="nav-link" href="../Utilisateurs_Interface/bt4/minisidebar/Etudiant_Master_Archive.php">Visualisation</a></li>
                        ...
                        <!-- User Profile -->
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown u-pro" style="padding-top: 6px;">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?='../Utilisateurs_Interface/bt4/minisidebar/'.$_SESSION['Image'] ?>" alt="user" class="" style="width: 30px;
    border-radius: 100%;"> <span class="hidden-md-down" style="color: rgba(255,255,255,.5);"><?=$_SESSION['Prenom_etudiant']?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <!-- text-->
                                <a href="<?php 
                                if($_SESSION['Cycle']=='Master'){
                                    echo"../Utilisateurs_Interface/bt4/minisidebar/Etudiant_Master_Profil.php";}
                                    else{
                                    echo"../Utilisateurs_Interface/bt4/minisidebar/Etudiant_Licence_Profil.php";
                                    }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                            echo "<input type='text' value='".$_SESSION['Prenom_etudiant']." ".$_SESSION['Nom_etudiant']."' class='form-control' name='name' id='name' placeholder='Nom' required>";
                                            ?>
                                        </div>
                                    </div>
                                    <!-- Single Input Area Start -->
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select class="form-control" name="email">
                                                <?php
                                                        echo "<option>".$_SESSION['Nom_filiere']."</option>";
                                                ?>
                                            </select>
                                        </div>
                                    </div>

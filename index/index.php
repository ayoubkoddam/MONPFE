                          ...
                          <a class="navbar-brand" href="#">MONPFE</a>
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    ...
                                    <li class="nav-item"><a  class="nav-link" href="../RedirectAuth/redirectAuth.php">Visualisation</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#contact">Aide</a></li>
                                </ul>
                                <div class="sing-up-button d-none d-lg-block">
                                    <a href="../RedirectAuth/redirectAuth.php">Se Connecter</a>
                                </div>
                            </div>
                        </nav>
                    </div>
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="contact_input_area">
                                <div class="row">
                                    ...
                                    <!-- Single Input Area Start -->
                                    <div class="col-12">
                                        <button type="submit" class="btn submit-btn" name="submit" >Envoyer</button>
                                    </div>
                                </div>
                            </div>
